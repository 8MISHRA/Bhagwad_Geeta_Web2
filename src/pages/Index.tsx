...
const Index = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-cover bg-center bg-no-repeat p-2 sm:p-3 md:p-4 relative" 
      style={{ backgroundImage: "url('/image/Designer.jpeg')" }}
    >
      {/* Overlay for better text readability */}
      <div className="absolute inset-0 bg-black/20"></div>

      <div className="relative z-10">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white text-center mb-3 sm:mb-4 md:mb-6">
