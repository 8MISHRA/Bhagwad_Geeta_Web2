...
export const GitaChatbot = () => {
  ...
  return (
    <Card className="flex flex-col h-[250px] bg-gradient-to-br from-[#F1F0FB] to-white border-2 border-[#9b87f5] shadow-lg rounded-xl">
      <div className="p-2 bg-[#9b87f5] text-white font-semibold rounded-t-lg flex items-center gap-2">
          ...
          <div className="space-y-3 p-3">
                ...
                <div
                  className={`inline-block p-2 rounded-xl max-w-[80%] text-sm ${
                    msg.type === "user"
                      ...
                      : "bg-[#F1F0FB] text-[#222222] border border-[#D6BCFA]"
                  }`}
                >
                  {msg.content}
                </div>
            ...
            {isLoading && (
              <div className="text-left">
                <div className="inline-block p-2 rounded-xl bg-[#F1F0FB] border border-[#D6BCFA] text-[#222222]">
                  <div className="flex gap-1 items-center">
                    <div className="w-1.5 h-1.5 bg-[#9b87f5] rounded-full animate-bounce"></div>
                    <div className="w-1.5 h-1.5 bg-[#9b87f5] rounded-full animate-bounce delay-100"></div>
                    <div className="w-1.5 h-1.5 bg-[#9b87f5] rounded-full animate-bounce delay-200"></div>
                  </div>
                </div>
              </div>
            )}
      ...
      <div className="p-2 border-t border-[#D6BCFA] bg-white">
        <div className="flex gap-2">
          <Input
            ...
            className="flex-1 border-[#9b87f5] focus:ring-[#9b87f5] text-sm h-8"
          />
          <Button 
            onClick={handleSend}
            className="bg-[#9b87f5] hover:bg-[#7E69AB] text-white transition-colors duration-200 h-8 px-3 text-sm"
          >
            Send
          </Button>
        </div>
