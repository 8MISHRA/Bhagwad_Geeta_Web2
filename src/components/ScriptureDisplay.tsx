...
export const ScriptureDisplay = ({ onVerseChange }: ScriptureDisplayProps) => {
  ...
  return (
    <Card className="p-4 bg-gradient-to-br from-[#F1F0FB] to-white border-2 border-[#9b87f5] shadow-lg rounded-xl h-full ">
      ...
      <div className="space-y-3">
        <div className="p-3 bg-white rounded-lg shadow-sm">
          <h3 className="font-semibold mb-2 flex items-center gap-2">
            <Book className="h-4 w-4 text-[#9b87f5]" />
            Sanskrit
          </h3>
        ...
        <div className="p-3 bg-white rounded-lg shadow-sm relative">
          <div className="absolute top-3 right-3 flex gap-2">
            <button
              ...
              className="p-1.5 hover:bg-[#F1F0FB] rounded-full transition-colors"
              title="Download PDF"
            >
              <Download className="h-4 w-4 text-[#9b87f5]" />
            </button>            <Dialog>
              ...
              <DialogContent className="max-w-4xl">
                <div className="border-2 border-[#9b87f5] rounded-lg p-4 h-[80vh]">
                  <iframe
